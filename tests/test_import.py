...
class PackageImportTest(unittest.TestCase):
    ...
    def test_root_public_api_exports_common_entrypoints(self) -> None:
        self.assertIsNotNone(src_py_lib.CallbackEventSink)
        self.assertIsNotNone(src_py_lib.CompositeEventSink)
        self.assertIsNotNone(src_py_lib.EventBridgeHandler)
        self.assertIsNotNone(src_py_lib.EventRuntime)
        self.assertIsNotNone(src_py_lib.EventSink)
        ...
        self.assertIsNotNone(src_py_lib.InMemoryEventSink)
        self.assertIsNotNone(src_py_lib.JSONDict)
        self.assertIsNotNone(src_py_lib.JSONLEventSink)
        ...
        self.assertIsNotNone(src_py_lib.NullEventSink)
        self.assertIsNotNone(src_py_lib.OpenTelemetryConfig)
        self.assertIsNotNone(src_py_lib.OpenTelemetrySettings)
        self.assertIsNotNone(src_py_lib.OtelLogsSink)
        self.assertIsNotNone(src_py_lib.cli_logging_handlers)
        self.assertIsNotNone(src_py_lib.cli_run_context)
        self.assertIsNotNone(src_py_lib.observability_context)
        ...
        self.assertIsNotNone(src_py_lib.configure_open_telemetry)
        ...
        self.assertIsNotNone(src_py_lib.log_event)
        ...
        self.assertIsNotNone(src_py_lib.open_telemetry_settings_from_config)
        ...
        self.assertIsNotNone(src_py_lib.span)
